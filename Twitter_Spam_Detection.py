...
data['Type']=data['Type'].map(dictionary)
...
#plotting graph
data["Type"].value_counts().plot(kind="bar", color=["salmon","lightblue"])
plt.xlabel("1 = Real , 2 = Fake ")
...
joblib.dump(model1,'final_pickle_model1.pkl')

final_model = joblib.load('final_pickle_model1.pkl')
...
("Accuracy of Final Model is {:.2f}%".format(accuracy*100))
